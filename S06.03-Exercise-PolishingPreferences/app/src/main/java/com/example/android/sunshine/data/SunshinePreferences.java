...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        // TODO (1) Return the user's preferred location Okay
    ...
    public static boolean isMetric(Context context) {
        // TODO (2) Return true if the user's preference for units is metric, false otherwise Okay

        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String unitMeasurement = sharedPreferences.getString(context.getString(R.string.pref_units_key), context.getString(R.string.pref_units_metric));
        return unitMeasurement.equals("metric");
    }
