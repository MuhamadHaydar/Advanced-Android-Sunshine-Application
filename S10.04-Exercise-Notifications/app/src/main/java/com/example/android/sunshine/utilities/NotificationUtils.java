...
public class NotificationUtils {
    ...
    //  TODO (1) Create a constant int value to identify the notification Okay
    public static final int WEATHER_NOTIFICATION_ID = 22;
...
//          TODO (2) Use NotificationCompat.Builder to begin building the notification Okay
...
//          TODO (3) Create an Intent with the proper URI to start the DetailActivity Okay
            Intent moveToDetailActivity = new Intent(context, DetailActivity.class);
            moveToDetailActivity.setData(todaysWeatherUri);

//          TODO (4) Use TaskStackBuilder to create the proper PendingIntent Okay
            TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);
            taskStackBuilder.addNextIntentWithParentStack(moveToDetailActivity);
            PendingIntent resultPendingIntent = taskStackBuilder
                    .getPendingIntent(0, PendingIntent.FLAG_UPDATE_CURRENT);


//          TODO (5) Set the content Intent of the NotificationBuilder Okay
            notificationBuilder.setContentIntent(resultPendingIntent);

//          TODO (6) Get a reference to the NotificationManager Okay
            NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);

//          TODO (7) Notify the user with the ID WEATHER_NOTIFICATION_ID Okay
            notificationManager.notify(WEATHER_NOTIFICATION_ID, notificationBuilder.build());

//          TODO (8) Save the time at which the notification occurred using SunshinePreferences Okay
