...
//  TODO (2) Remove all the TextView declarations Okay
     ...
     */
//  TODO (3) Declare an ActivityDetailBinding field called mDetailBinding Okay
    ActivityDetailBinding mDetailBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//      TODO (4) Remove the call to setContentView Okay


//      TODO (5) Remove all the findViewById calls Okay


//      TODO (6) Instantiate mDetailBinding using DataBindingUtil Okay
...
//      TODO (7) Display the weather icon using mDetailBinding Okay
        ...
        int imageResourceId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
        mDetailBinding.primaryWeatherInfo.weatherIcon.setImageResource(imageResourceId);
...
//      TODO (8) Use mDetailBinding to display the date Okay
        mDetailBinding.primaryWeatherInfo.date.setText(dateText);


        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId);

//      TODO (15) Create the content description for the description for a11y Okay
        String descriptionA11y = getString(R.string.a11y_forecast, description);

//      TODO (9) Use mDetailBinding to display the description and set the content description Okay
...
//      TODO (16) Set the content description of the icon to the same as the weather description a11y text Okay
...
//      TODO (17) Create the content description for the high temperature for a11y Okay
        String highTempA11y = getString(R.string.a11y_high_temp, highString);

//      TODO (10) Use mDetailBinding to display the high temperature and set the content description Okay
...
//      TODO (18) Create the content description for the low temperature for a11y Okay
        String lowTempA11y = getString(R.string.a11y_low_temp, lowString);

//      TODO (11) Use mDetailBinding to display the low temperature and set the content description Okay
...
//      TODO (20) Create the content description for the humidity for a11y Okay
        String humidityA11y = getString(R.string.a11y_humidity, humidityString);

//      TODO (12) Use mDetailBinding to display the humidity and set the content description Okay
...
//      TODO (19) Set the content description of the humidity label to the humidity a11y String Okay
...
//      TODO (21) Create the content description for the wind for a11y Okay
        String windA11y = getString(R.string.a11y_wind, windString);

//      TODO (13) Use mDetailBinding to display the wind and set the content description Okay
...
//      TODO (22) Set the content description of the wind label to the wind a11y String Okay
        mDetailBinding.extraWeatherDetails.windLabel.setContentDescription(windA11y);
...
//      TODO (23) Create the content description for the pressure for a11y Okay
        String pressureA11y = getString(R.string.a11y_pressure, pressureString);

//      TODO (14) Use mDetailBinding to display the pressure and set the content description Okay
...
//      TODO (24) Set the content description of the pressure label to the pressure a11y String Okay
